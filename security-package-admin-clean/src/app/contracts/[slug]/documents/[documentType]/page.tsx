...
export default async function ContractDocumentPage({
          ...
          <div className="rounded-md border border-line bg-white p-8">
            ...
            <div className="mb-6 grid gap-4 md:grid-cols-2">
              <div className="rounded-md border border-line p-4">
                ...
                <p className="mt-2 text-sm text-steel">ROV 수중 검사 및 해양 기술지원</p>
                <p className="mt-1 text-sm text-steel">contact@kudalabs.example</p>
              </div>
              <div className="rounded-md border border-line p-4">
                <p className="mb-3 text-sm font-bold text-marine">공급받는 자</p>
                <p className="font-bold text-ink">{contract.client}</p>
                <p className="mt-2 text-sm text-steel">담당자: 김도윤 팀장</p>
            ...
            <div className="mb-6 grid gap-4 md:grid-cols-[1fr_280px]">
              <div className="rounded-md border border-line p-4">
                ...
                <ul className="space-y-2 text-sm text-steel">
                  <li>ROV 장비 투입 및 수중 검사 수행</li>
                  <li>검사 데이터 정리 및 결과 리포트 제공</li>
        ...
        <section className="grid gap-4 xl:grid-cols-[1fr_360px]">
          <div className="rounded-md border border-line bg-white p-8">
            <div className="mb-8 border-b-2 border-ink pb-6 text-center">
              ...
              <p className="mt-3 text-sm text-steel">{contract.id} · 작성일 2026-06-08</p>
            </div>
  ...
  if (documentType === "expense-resolution") {
    const expenseItems = [
      { category: "장비비", description: "ROV 장비 투입 및 점검 소모품", amount: "420만원" },
      { category: "출장비", description: "현장 이동, 숙박, 식대", amount: "180만원" },
      { category: "외주비", description: "잠수 지원 및 안전 감시 인력", amount: "260만원" }
    ];
            ...
            <div className="grid gap-4 md:grid-cols-[1fr_280px]">
              ...
              <section className="rounded-md bg-paper p-4">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-bold text-ink">860만원</span>
                </div>
                <div className="mt-3 flex justify-between text-sm">
                ...
                <div className="mt-4 border-t border-line pt-4">
                  <div className="flex justify-between">
                    ...
                    <span className="text-xl font-bold text-marine">69%</span>
                  </div>
                </div>
              </section>
            </div>
            ...
            <section className="rounded-md border border-line bg-white p-5">
              ...
              <div className="space-y-3">
                <div className="rounded-md bg-paper px-3 py-3">
                  ...
                  <p className="mt-1 text-sm font-bold text-ink">로컬 테스트 모드</p>
                </div>
                <div className="rounded-md bg-paper px-3 py-3">
