  ...
  return (
    <div className="space-y-5">
      <section className="overflow-hidden rounded-lg border border-[#c4d3dc] bg-white shadow-sm">
        <div className="flex flex-col gap-3 bg-[#0b5578] px-4 py-4 text-white sm:flex-row sm:items-center sm:justify-between sm:px-6">
          <div>
      ...
      <section className="overflow-hidden rounded-lg border-2 border-[#6a8798] bg-white shadow-sm">
        <div className="flex items-center justify-between gap-2 border-b-2 border-[#6a8798] bg-[#eef3f6] px-4 py-3 sm:px-6"><h3 className="text-lg font-bold text-[#18394d]">세금계산서</h3><span className="text-xs text-[#657a88]">* 필수</span></div>
        ...
        <div className="min-w-0 p-3 sm:p-5">
          ...
          <section className="mt-6 min-w-0">
            ...
            <div className="mt-3 min-w-0 overflow-x-auto overscroll-x-contain rounded-md border border-[#aebfcb]">
              <table className="w-full min-w-[820px] table-fixed border-collapse text-sm">
                ...
                <thead className="bg-[#eaf0f4] text-xs font-semibold text-[#3f5969]"><tr><th className="border-b border-r border-[#aebfcb] px-2 py-3 text-left whitespace-nowrap">월/일</th><th className="border-b border-r border-[#aebfcb] px-2 py-3 text-left whitespace-nowrap">품목</th><th className="border-b border-r border-[#aebfcb] px-2 py-3 text-left whitespace-nowrap">규격</th><th className="border-b border-r border-[#aebfcb] px-2 py-3 text-right whitespace-nowrap">수량</th><th className="border-b border-r border-[#aebfcb] px-2 py-3 text-right whitespace-nowrap">단가</th><th className="border-b border-r border-[#aebfcb] px-2 py-3 text-right whitespace-nowrap">공급가액</th><th className="border-b border-r border-[#aebfcb] px-2 py-3 text-right whitespace-nowrap">세액</th><th className="border-b border-[#aebfcb] px-1 py-3" aria-label="품목 삭제" /></tr></thead>
                <tbody>
